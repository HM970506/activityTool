...
export default function fabricSetting() {
  ...
  fabric.BaseBrush.prototype.convertToImg = function() {
    ...
    img.set(
      {
        left:xy.x/pixelRatio-this.canvas.viewportTransform[4]        ,
        top:xy.y/pixelRatio-this.canvas.viewportTransform[5] ,
        'scaleX':1/pixelRatio,'scaleY':1/pixelRatio}).setCoords();
